...
LEFT JOIN sys.index_columns idx_col ON col.object_id=idx_col.object_id AND col.column_id=idx_col.column_id
LEFT JOIN sys.indexes idx ON col.object_id=idx.object_id AND idx_col.index_id=idx.index_id
WHERE o.name=@table";
